  ...
  return (
    <div class="min-h-screen">
      <div class="flex flex-col items-center justify-center">
        <h1 class="font-stretch-150% font- m-0 p-0 leading-none text-[7svw] max-w-full text-nowrap font-bold overflow-hidden text-center antialiased md:subpixel-antialiased">
          HOME FILM FESTIVAL
        </h1>
        ...
        <main className="grid grid-cols-1 grid-rows-3 gap-4 w-full">
